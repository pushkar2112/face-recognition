...
subjects = ["", "Ramiz Raja", "Elvis Presley", "Elon Musk", "Tom Cruise"]
...
faces, labels = prepare_training_data("face-recog/training-data")
print("Data prepared")
...
#load test images
test_img1 = cv2.imread("face-recog/test-data/test1.jpg")
test_img2 = cv2.imread("face-recog/test-data/test2.jpg")
test_img3 = cv2.imread("face-recog/test-data/test3.jpg")
test_img4 = cv2.imread("face-recog/test-data/test4.jpg")
